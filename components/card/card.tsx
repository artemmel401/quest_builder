...
import { deleteQuest } from '@/utils/requests'
import { BigSelector } from '../newComponents/selectors/selectors'
...
export default function Card({title, description, background, isTemplate, isSelected, onClick, onDelete}: CardProps){
  ...
  return (
    <div className={styles.container} onClick={onClick}>
      ...
      {isTemplate ? <div className={styles.container__selector}><BigSelector checked={isSelected!==undefined ? isSelected : false} /></div> :
      <svg onClick={(e)=>{e.stopPropagation();onDelete()}} className={styles.container__delete} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
